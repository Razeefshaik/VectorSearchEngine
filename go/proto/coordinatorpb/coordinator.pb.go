...
const file_coordinator_proto_rawDesc = "" +
	...
	"\x06Search\x12*.vectorsearch.coordinator.v1.SearchRequest\x1a+.vectorsearch.coordinator.v1.SearchResponseB*Z(hnswdb/proto/coordinatorpb;coordinatorpbb\x06proto3"
